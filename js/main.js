...
Hooks.once("init", () => {
	...
	game.settings.register("pf2edragruler-metric", "offTurnMovement", {
        name: game.i18n.localize("pf2edragruler-metric.settings.offTurnMovement.name"),
        hint: game.i18n.localize("pf2edragruler-metric.settings.offTurnMovement.hint"),
        scope: "world",
        config: true,
        type: Boolean,
        default: false
    })
    game.settings.register("pf2edragruler-metric", "auto", {
